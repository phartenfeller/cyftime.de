...
const availability = [
  {
    name: 'Spotify',
    url: 'https://open.spotify.com/album/6PJ4TnHVzmG09FSLZZtSGS',
    svgPath:
  ...
  },
  {
    name: 'Apple Music',
    url:
      'https://music.apple.com/de/album/fast-life-feat-etchizzz-stapes-single/1486977265',
    svgPath:
  ...
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/watch?v=JezZqhmNBZ8',
    svgPath:
  ...
  {
    name: 'Deezer',
    url: 'https://www.deezer.com/de/album/118142502',
    svgPath:
  ...
  {
    name: 'Tidal',
    url: 'https://listen.tidal.com/album/122027975',
    svgPath:
  ...
  {
    name: 'Amazon',
    url: 'https://music.amazon.com/albums/B08163K49D?trackAsin=B0815RHND7',
    svgPath:
  ...
  },
  {
    name: 'Google Play',
    url:
      'https://play.google.com/store/music/album/Cyf_Fast_Life_feat_Etchizzz_Stapes?id=B5gnsj3w4wvh6bhbqekkels27ya',
    svgPath:
...
const Bokassa = () => {
  const data = useStaticQuery(graphql`
    query FastLifeCover {
      image: file(relativePath: { eq: "cyf_fast_life_single_project.jpg" }) {
        id
        childImageSharp {
          fluid {
