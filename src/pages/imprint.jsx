  ...
  <Layout>
    ...
    <div className="h-screen">
      ...
      <div className="mx-4 md:mx-12 lg:mx-48 text-gray-400">
        ...
        <h2 className="text-2xl font-bold mt-8 text-gray-100">Kontakt</h2>
        <p>
          Telefon: 01746896548
          <br />
          E-Mail: contact@cyftime.de
        </p>
        <h3 className="text-xl mt-4 text-gray-200">Haftung f&uuml;r Inhalte</h3>
        <p>
        ...
        <h3 className="text-xl mt-4 text-gray-200">Haftung f&uuml;r Links</h3>
        <p>
        ...
        <h3 className="text-xl mt-4 text-gray-200">Urheberrecht</h3>
        <p>
